...
export const gondorMordorExpansion = {
    ...
    gorgoroth_plateau: {
        ...
        exits: {
            north: 'mordor_plains',
            south: 'mount_doom_approach',
            east: 'barad_dur_approach'
        },
        items: ['scorched_bone'],
