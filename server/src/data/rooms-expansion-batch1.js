...
export const shireExpansion = {
    ...
    brandy_hall: {
        ...
        exits: {
            west: 'bucklebury',
            east: 'buckland_kitchen',
            south: 'buckland_cellar'
        },
    ...
    old_forest_exit: {
        ...
        exits: {
            west: 'bombadil_house', // connects to existing
    ...
    barrow_downs_approach: {
        ...
        exits: {
            west: 'old_forest_exit',
            east: 'barrow_downs',
            north: 'weathertop_approach'
        },
        items: [],
        enemies: []
    },
    ...
    barrow_downs: {
        ...
        exits: {
            west: 'barrow_downs_approach',
            east: 'barrow_chamber_1',
            north: 'barrow_chamber_2',
            south: 'barrow_chamber_3'
        },
        items: [],
    ...
    weathertop_summit: {
        ...
        exits: { down: 'weathertop_approach' },
    ...
    annuminas_ruins: {
        ...
        exits: {
            west: 'annuminas_approach',
            east: 'annuminas_tower',
            south: 'lake_evendim'
        },
