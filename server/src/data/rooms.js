...
export const rooms = {
    ...
    bag_end: {
        ...
        exits: { 'north': 'tuckborough', 'south': 'tookbank', 'east': 'michel_delving', 'west': 'mayor_office' },
    ...
    hobbiton_square: {
        ...
        exits: { 'southeast': 'entwash_delta', 'northwest': 'cerin_amroth' },
        items: ['silver_coin'],
        enemies: []
    },
    ...
    green_dragon: {
        ...
        exits: { 'southwest': 'aldburg', 'northeast': 'caras_galadhon' },
    ...
    bywater: {
        ...
        exits: { 'southeast': 'snowbourn_banks', 'northwest': 'galadriel_court' },
        items: ['rope'],
        enemies: []
    },
    ...
    woody_end: {
        ...
        exits: { 'southwest': 'starkhorn_foothills', 'northeast': 'mirror_chamber' },
        items: [],
        enemies: ['wild_wolf']
    },
    ...
    brandywine_bridge: {
        ...
        exits: { 'north': 'dimholt_road', 'south': 'silverlode_banks', 'southeast': 'anduin_approach', 'southwest': 'anduin_midstream' },
        items: [],
        enemies: []
    },
    ...
    stock_road: {
        ...
        exits: { 'northwest': 'dimholt_road', 'southeast': 'parth_galen' },
        items: ['carrot'],
        enemies: []
    },
    ...
    marish: {
        ...
        exits: { 'northeast': 'dimholt_road', 'southwest': 'amon_hen' },
    ...
    old_forest_entrance: {
        ...
        exits: { 'northwest': 'dunharrow_firtree_grove', 'southeast': 'rauros_falls_approach' },
        items: [],
        enemies: ['huorn']
    },
    ...
    old_forest_depth: {
        ...
        exits: { 'northeast': 'hidden_valley_white_mountains', 'southwest': 'gap_of_rohan' },
        items: ['ancient_acorn'],
        enemies: []
    },
    ...
    withywindle: {
        ...
        exits: { 'northwest': 'deeping_stream_upper', 'southeast': 'rohan_plains' },
        items: [],
    ...
    bombadil_house: {
        ...
        exits: { 'northeast': 'hornburg_armory', 'southwest': 'edoras_approach' },
    ...
    bree_gate: {
        ...
        exits: { 'northeast': 'deep_coomb', 'southwest': 'edoras_gates' },
        items: [],
        enemies: []
    },
    ...
    bree_square: {
        ...
        exits: { 'northwest': 'west_emnet', 'southeast': 'meduseld' },
        items: ['brass_key'],
        enemies: []
    },
    ...
    prancing_pony: {
        ...
        exits: { 'northeast': 'wold_of_rohan', 'southwest': 'harrowdale' },
        items: ['ranger_cloak'],
        enemies: []
    },
    ...
    bree_east_road: {
        ...
        exits: { 'northwest': 'ithilien_woods', 'southeast': 'dunharrow' },
        items: [],
        enemies: []
    },
    ...
    weathertop_base: {
        ...
        exits: { 'northeast': 'henneth_annun', 'southwest': 'paths_of_dead' },
        items: ['ancient_blade'],
        enemies: ['orc_scout']
    },
    ...
    midgewater_marshes: {
        ...
        exits: { 'northwest': 'minas_tirith_stables', 'southeast': 'dead_city' },
        items: [],
    ...
    weatherhills: {
        ...
        exits: { 'west': 'minas_tirith_houses_of_healing', 'east': 'helms_gate', 'northeast': 'helms_deep_interior', 'southeast': 'glittering_caves' },
    ...
    last_bridge: {
        ...
        exits: { 'southwest': 'minas_tirith_houses_of_healing', 'northeast': 'fangorn_border' },
        items: ['elven_berries'],
        enemies: []
    },
    ...
    trollshaws: {
        ...
        exits: { 'northwest': 'minas_tirith_houses_of_healing', 'southeast': 'fangorn_eaves' },
        items: [],
        enemies: []
    },
    ...
    troll_cave: {
        ...
        exits: { 'southwest': 'citadel_guards_hall', 'northeast': 'fangorn_depths' },
    ...
    ford_of_bruinen: {
        ...
        exits: { 'northwest': 'pelargir_port', 'southeast': 'wellinghall' },
        items: [],
        enemies: []
    },
    ...
    rivendell_gates: {
        ...
        exits: { 'southwest': 'lossarnach_valleys', 'northeast': 'entwash' },
        items: [],
        enemies: []
    },
    ...
    rivendell_hall: {
        ...
        exits: { 'northwest': 'minas_morgul_gates', 'southeast': 'east_emnet' },
    ...
    rivendell_library: {
        ...
        exits: { 'southwest': 'minas_morgul_interior', 'northeast': 'isengard_gates' },
    ...
    rivendell_forge: {
        ...
        exits: { 'northwest': 'gorgoroth_plateau', 'southeast': 'orthanc_base' },
        items: ['elvish_blade'],
        enemies: []
    },
    ...
    hollin_gate: {
        ...
        exits: { 'southwest': 'mount_doom_sammath_naur', 'northeast': 'orthanc_chamber' },
    ...
    doors_of_durin: {
        ...
        exits: { 'northwest': 'barad_dur_throne_room', 'southeast': 'osgiliath_ruins' },
        items: [],
        enemies: [],
    ...
    moria_entrance: {
        ...
        exits: { 'east': 'durthang_fortress', 'west': 'pelennor_fields', 'northwest': 'minas_tirith_gates', 'southwest': 'white_tower' },
    ...
    twenty_first_hall: {
        ...
        exits: { 'southeast': 'durthang_fortress', 'northwest': 'rath_dinen' },
    ...
    balin_tomb: {
        ...
        exits: { 'northeast': 'durthang_fortress', 'southwest': 'house_of_stewards' },
    ...
    seventh_level: {
        ...
        exits: { 'southeast': 'grey_havens_docks', 'northwest': 'morgul_vale' },
        items: [],
    ...
    sixth_level: {
        ...
        exits: { 'northeast': 'havens_approach', 'southwest': 'morgul_pass' },
        items: [],
    ...
    goblin_warren: {
        ...
        exits: { 'southeast': 'mirkwood_edge', 'northwest': 'cirith_ungol' },
    ...
    fifth_level: {
        ...
        exits: { 'northeast': 'mirkwood_path_1', 'southwest': 'shelob_lair' },
    ...
    fourth_level: {
        ...
        exits: { 'southeast': 'mirkwood_path_2', 'northwest': 'tunnel_exit' },
        items: [],
        enemies: ['cave_troll']
    },
    ...
    third_level: {
        ...
        exits: { 'northeast': 'mirkwood_depths', 'southwest': 'mordor_plains' },
        items: ['deep_crystal'],
        enemies: ['orc_warrior']
    },
    ...
    durin_chamber: {
        ...
        exits: { 'southeast': 'rhosgobel', 'northwest': 'black_gate' },
    ...
    second_level: {
        ...
        exits: { 'northeast': 'elf_path_entrance', 'southwest': 'barad_dur_approach' },
        items: ['pickaxe'],
    ...
    mithril_mine: {
        ...
        exits: { 'south': 'thranduil_halls_gate', 'north': 'barad_dur_base', 'northeast': 'barad_dur_chamber', 'northwest': 'mount_doom_approach' },
    ...
    first_level: {
        ...
        exits: { 'southwest': 'thranduil_halls_gate', 'northeast': 'mount_doom_summit' },
        items: [],
        enemies: ['orc_warrior', 'goblin']
    },
    ...
    bridge_of_khazad_dum: {
        ...
        exits: { 'southeast': 'thranduil_halls_gate' },
        items: [],
        enemies: ['durin_bane']
    },
    ...
    east_gate_approach: {
        ...
        exits: { 'southwest': 'thranduil_halls_interior' },
    ...
    east_gate_moria: {
        ...
        exits: { 'southeast': 'long_lake_path' },
        items: [],
        enemies: []
    },
    ...
    dimrill_dale: {
        ...
        exits: { 'southwest': 'lake_town_docks' },
    ...
    mines_level1: {
        ...
        exits: { 'southeast': 'lonely_mountain_approach' },
    ...
    endless_stair_top: {
        ...
        exits: { 'southeast': 'erebor_great_hall' },
        items: [],
        enemies: []
    },
    ...
    endless_stair_bottom: {
        ...
        exits: { 'southeast': 'erebor_treasury' },
        items: ['ancient_key'],
        enemies: ['orc_warrior']
    },
    ...
    cerin_amroth: {
        ...
        exits: { 'southeast': 'hobbiton_square' },
    ...
    anduin_approach: {
        ...
        exits: { 'northwest': 'brandywine_bridge' },
        items: ['elven_boat'],
        enemies: []
    },
    ...
    anduin_midstream: {
        ...
        exits: { 'northeast': 'brandywine_bridge' },
        items: [],
        enemies: []
    },
    ...
    rauros_falls_approach: {
        ...
        exits: { 'northwest': 'old_forest_entrance' },
        items: [],
        enemies: []
    },
    ...
    gap_of_rohan: {
        ...
        exits: { 'northeast': 'old_forest_depth' },
        items: [],
    ...
    edoras_approach: {
        ...
        exits: { 'northeast': 'bombadil_house' },
        items: [],
        enemies: []
    },
    ...
    dunharrow: {
        ...
        exits: { 'northwest': 'bree_east_road' },
    ...
    paths_of_dead: {
        ...
        exits: { 'northeast': 'weathertop_base' },
        items: [],
    ...
    dead_city: {
        ...
        exits: { 'northwest': 'midgewater_marshes' },
    ...
    wellinghall: {
        ...
        exits: { 'northwest': 'ford_of_bruinen' },
        items: ['ent_staff'],
        enemies: []
    },
    ...
    entwash: {
        ...
        exits: { 'southwest': 'rivendell_gates' },
        items: [],
        enemies: []
    },
    ...
    east_emnet: {
        ...
        exits: { 'northwest': 'rivendell_hall' },
        items: [],
        enemies: []
    },
    ...
    isengard_gates: {
        ...
        exits: { 'southwest': 'rivendell_library' },
        items: [],
        enemies: ['uruk_hai', 'uruk_hai']
    },
    ...
    orthanc_base: {
        ...
        exits: { 'northwest': 'rivendell_forge' },
        items: ['broken_staff'],
        enemies: []
    },
    ...
    osgiliath_ruins: {
        ...
        exits: { 'northwest': 'doors_of_durin' },
    ...
    minas_tirith_gates: {
        ...
        exits: { 'southeast': 'moria_entrance' },
        items: [],
        enemies: []
    },
    ...
    white_tower: {
        ...
        exits: { 'northeast': 'moria_entrance' },
    ...
    rath_dinen: {
        ...
        exits: { 'southeast': 'twenty_first_hall' },
        items: [],
        enemies: []
    },
